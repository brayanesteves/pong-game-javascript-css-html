...
let Game = {
   ...
   endGameMenu:function(text) {
       ...
       Pong.context.fillText(Pong.canvas.width / 2, Pong.canvas.height / 2 + 15);
   ...
   menu:function() {
       ...
       this.context.fillText('Press a Key to begin', this.canvas.width /  2, this.canvas.height /  2 + 15);
   },

   // Update all objects (Move the player, AI, ball, increment the score, etc.
   update:function() {
       if(!this.over) {
           // If the ball collides with the bound limits - correct the 'x' and 'y' corrds.
           if(this.ball.x <= 0) {
           ...
           // and randomize the diretion to add some challenge.
